...
$routes->get('/infokegiatan', 'UserController::infoKegiatan');
$routes->get('/datasiswa', 'UserController::dataSiswa');
...
$routes->get('/siswa/new', 'SiswaController::new');
$routes->get('/siswa/(.*)/edit', 'SiswaController::edit/$1');
$routes->get('/siswa/(.*)', 'SiswaController::show/$1');
$routes->post('/siswa', 'SiswaController::create');
$routes->patch('/siswa/(.*)', 'SiswaController::update/$1');
